...
// $[I2C0]
#define PORTIO_I2C0_SCL_PIN                   (0U)
#define PORTIO_I2C0_SCL_PORT                  (gpioPortB)

#define PORTIO_I2C0_SDA_PIN                   (1U)
#define PORTIO_I2C0_SDA_PORT                  (gpioPortB)

#define HAL_I2C0_ENABLE                       (1)

#define BSP_I2C0_SCL_PIN                      (0U)
#define BSP_I2C0_SCL_PORT                     (gpioPortB)

#define BSP_I2C0_SDA_PIN                      (1U)
